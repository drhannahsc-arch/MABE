...
PARAM_SPEC = [
    ...
    ("ex_O_carboxylate",    "EXCHANGE", "O_carboxylate",     -6.36,  -30.0,   8.0),
    ("ex_O_phenolate",      "EXCHANGE", "O_phenolate",      -17.49,  -60.0,   0.0),
    ("ex_O_hydroxamate",    "EXCHANGE", "O_hydroxamate",     -8.42,  -60.0,   0.0),
    ("ex_O_catecholate",    "EXCHANGE", "O_catecholate",    -15.00,  -80.0,   0.0),
    ("ex_O_ether",          "EXCHANGE", "O_ether",            4.19,  -15.0,  20.0),
    ("ex_O_hydroxyl",       "EXCHANGE", "O_hydroxyl",        -2.00,  -50.0,   8.0),  # widened from -30
    ("ex_N_amine",          "EXCHANGE", "N_amine",          -14.90,  -40.0,   0.0),
    ("ex_N_pyridine",       "EXCHANGE", "N_pyridine",        -9.23,  -35.0,   0.0),
    ("ex_N_imine",          "EXCHANGE", "N_imine",           -8.00,  -35.0,   5.0),
    ("ex_N_imidazole",      "EXCHANGE", "N_imidazole",       -7.40,  -30.0,   5.0),
    ("ex_N_amide",          "EXCHANGE", "N_amide",          -19.00,  -40.0,   0.0),
    ("ex_S_thiolate",       "EXCHANGE", "S_thiolate",       -15.80,  -60.0,   0.0),
    ("ex_S_dithiocarbamate","EXCHANGE", "S_dithiocarbamate", -9.30,  -50.0,   5.0),  # widened from 0
    ("ex_S_thioether",      "EXCHANGE", "S_thioether",        5.00,  -25.0,  15.0),
    ("ex_S_thiosulfate",    "EXCHANGE", "S_thiosulfate",     -8.00,  -30.0,   5.0),
    ("ex_P_phosphine",      "EXCHANGE", "P_phosphine",      -20.00,  -60.0,   0.0),
    ("ex_Cl_chloride",      "EXCHANGE", "Cl_chloride",       -0.29,  -35.0,  10.0),
    ("ex_Br_bromide",       "EXCHANGE", "Br_bromide",        -6.00,  -30.0,   5.0),
    ("ex_I_iodide",         "EXCHANGE", "I_iodide",         -12.00,  -40.0,   0.0),

    # ── Irving-Williams bonuses: 3d series (kJ/mol) ──
    ("iw_Mn2+", "IW", "Mn2+",  -5.0, -30.0, 20.0),   # widened from 12
    ("iw_Fe2+", "IW", "Fe2+",  -9.0, -35.0, 12.0),   # widened from 8
    ("iw_Co2+", "IW", "Co2+", -12.0, -40.0, 12.0),   # widened high from 5
    ("iw_Ni2+", "IW", "Ni2+", -15.0, -45.0,  5.0),   # widened high from 0
    ("iw_Cu2+", "IW", "Cu2+", -18.0, -50.0,  0.0),
    ("iw_Zn2+", "IW", "Zn2+",  -7.0, -30.0,  8.0),   # widened

    # ── Irving-Williams: heavy metals + trivalent (NEW in round 2) ──
    ("iw_Pb2+", "IW", "Pb2+",  -2.0, -30.0,  10.0),
    ("iw_Hg2+", "IW", "Hg2+",  -5.0, -40.0,  15.0),
    ...
    # cn_pref_penalty: not fitted (optimizer minimizes it). Set to 0 in scorer.
    ("jt_strong",       "PARAMS", "jt_strong",        -12.00, -35.0,   -1.0),
    ("jt_moderate",     "PARAMS", "jt_moderate",       -6.00, -20.0,   -0.5),
]
