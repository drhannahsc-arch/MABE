"""
MABE Platform - Sprint 17 Bootstrap Script
Creates: Generative -> Physics Pipeline Adapter

  core/generative_physics_adapter.py  - Adapter + 10-term dG scoring + design_and_score()
  tests/test_sprint17.py              - 20 tests

Requires Sprint 16 files already in place.
Run from MABE root: python bootstrap_sprint17.py
Then: python tests/test_sprint17.py
"""
...
print("\n\U0001f528 MABE Sprint 17 \u2014 Generative -> Physics Pipeline\n")
...
def test_adapt_preserves_hsab():
    ...
    a = adapt_generative_to_pipeline(gen)
    assert a.recognition.hsab_match > 0.5
    assert a.recognition.donor_type in ("soft", "mixed")
...
print("""
\u2705 Sprint 17 files created!

  core/generative_physics_adapter.py  \u2190 Adapter + 10-term \u0394G + design_and_score()
  tests/test_sprint17.py              \u2190 20 tests

Pipeline: design_and_score("nickel", "Ni2+")
  \u2192 Generative engine (Sprint 16): novel binder architectures
  \u2192 Adapter: GenerativeBinderAssembly \u2192 BinderAssembly
  \u2192 Physics scoring: 10-term \u0394G + temperature prediction
  \u2192 Ranked results with full thermodynamic breakdown

Run: python tests/test_sprint17.py
""")