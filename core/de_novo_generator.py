...
ARM_LIBRARY = [
    ...
    # ── ANION/OXOANION ARMS (added by arm_selector bootstrap) ───────────
    Arm("bis-urea", "[*]NC(=O)NC(=O)N",
        ["N_urea", "N_urea", "O_carbonyl", "O_carbonyl"], "N", "hard",
        "4 NH donors + 2 C=O, strong oxoanion binding"),
    Arm("amidinium", "[*]C(=N)N",
        ["N_amine", "N_amine"], "N", "hard",
        "Cationic H-bond donor pair for anions"),
    Arm("triazole-NH", "[*]c1cn[nH]n1",
        ["N_pyrrole", "N_pyridine"], "N", "borderline",
        "1,2,3-Triazole NH donor, click-accessible"),
    Arm("indole-amide", "[*]NC(=O)c1c[nH]c2ccccc12",
        ["N_amide", "N_pyrrole", "O_carbonyl"], "N", "borderline",
        "Indole NH + amide NH convergent donors"),
    Arm("amino-thiourea", "[*]NC(=S)NN",
        ["N_amine", "N_amine", "S_thiolate"], "N", "borderline",
        "Thiourea NH donors + terminal hydrazine"),
    Arm("amino-pyridine", "[*]Nc1ccccn1",
        ["N_amine", "N_pyridine"], "N", "borderline",
        "2-Aminopyridine bidentate for oxoanions"),
    Arm("hydroxamic-extended", "[*]CCC(=O)NO",
        ["O_hydroxamate", "O_hydroxamate"], "O", "hard",
        "Extended hydroxamate with propyl spacer"),
    Arm("chromone-hydroxyl", "[*]c1cc(=O)c2ccccc2o1",
        ["O_carbonyl", "O_hydroxyl"], "O", "hard",
        "Chromone C=O + ring O, planar aromatic arm"),
    Arm("phosphoryl-NH", "[*]NP(=O)(O)O",
        ["N_amine", "O_phosphate", "O_phosphate"], "N", "hard",
        "Phosphoramide NH + phosphoryl oxygens"),
    Arm("cyanuric-NH", "[*]Nc1nc(N)[nH]c(=O)n1",
        ["N_amine", "N_amine", "O_carbonyl"], "N", "hard",
        "Cyanuric acid derivative, planar H-bond array"),
        Arm("H-cap", "[*][H]", [], "", "", "cap"),
