"""
MABE Platform - Sprint 16 v2 Bootstrap: Diverse Coordination Generation
Replaces Sprint 16 v1 with improved generator that produces diverse designs.
Key fixes: continuous softness, multiple donor strategies, dedup.
Run: python bootstrap_sprint16_v2.py
...
print("\n\U0001f528 MABE Sprint 16 v2 \u2014 Diverse Coordination Generation\n")
...
METAL_D_ELECTRONS = {
    ...
    "Cd2+": 10, "La3+": 0, "Ce3+": 1, "Au+": 10, "Au3+": 8, "Pt2+": 8,
