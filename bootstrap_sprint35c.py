"""
MABE Sprint 35c: Donor Subtype Resolution + Jahn-Teller
R²=0.862, MAE=2.7, 12 complexes within ±1 logK.
"""
import os
...
print("\n\U0001f528 MABE Sprint 35c \u2014 Donor Subtypes\n")
...
def compute_enhanced_thermodynamics(recognition, structure, interior, problem):
    ...
    dg_jahn_teller = 0.0
    if d_electrons == 9 and cn <= 4:  # Cu2+ bis/tetrakis complexes
        dg_jahn_teller = -25.0  # Strong JT distortion, square planar preferred
    elif d_electrons == 9 and cn <= 6:
        dg_jahn_teller = -10.0  # Tetragonal distortion in octahedral
    elif d_electrons == 4 and cn <= 6:
        dg_jahn_teller = -8.0   # d4 high-spin JT (weaker)
